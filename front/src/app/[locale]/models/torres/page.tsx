...
const TorresPage = () => {
  ...
  const carColors = [
    {
      ...
      vrImages: {
        oneTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/dandy-blue-1tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
        twoTone: Array.from(
    ...
    },
    {
      ...
      vrImages: {
        oneTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/forest-green-1tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
        twoTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/forest-green-2tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
      },
    },
    {
      ...
      vrImages: {
        oneTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/grand-white-1tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
        twoTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/grand-white-2tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
      },
    },
    {
      ...
      vrImages: {
        oneTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/iron-metal-1tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
        twoTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/iron-metal-2tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
      },
    },
    {
      ...
      vrImages: {
        oneTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/latte-greige-1tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
        twoTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/latte-greige-2tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
      },
    },
    {
      ...
      vrImages: {
        oneTone: Array.from(
          { length: 36 },
          (_, i) =>
            `/assets/Modelspage/TORRES/vr360/space-black-1tone/${String(
              i + 1
            ).padStart(2, "0")}.png`
        ),
        twoTone: Array.from(
  ...
  return (
    <div className="min-h-screen bg-black text-white w-full overflow-x-hidden">
      <SEO
        title="KGM Torres | SUV Premium au Maroc"
        description="Découvrez le KGM Torres, SUV premium au Maroc. Technologie de pointe, design élégant, performances exceptionnelles. Réservez votre essai."
        keywords="KGM Torres, SUV premium Maroc, Torres prix, SUV KGM, KGM Mobility"
        titleFr="KGM Torres | SUV Premium au Maroc"
        descriptionFr="Découvrez le KGM Torres, SUV premium au Maroc. Technologie de pointe, design élégant, performances exceptionnelles. Réservez votre essai."
        keywordsFr="KGM Torres, SUV premium Maroc, Torres prix, SUV KGM, KGM Mobility"
      />
      <Navbar />
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          {/* Bottom Content - TORRES title, subtitle, and buttons */}
          <div className="flex justify-center lg:justify-start px-4 sm:px-8 lg:px-16 pb-8 sm:pb-12 lg:pb-16">
            ...
            >
              ...
              >
                {language === "fr"
                  ? "Découvrez la puissance et l'élégance du nouveau Torres"
      ...
      {/* Exterior Section */}
      <section className="relative min-h-[800px] bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden ">
        {/* Background gradient */}
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            style={{
              backgroundImage:
                "url(/assets/Modelspage/TORRES/section4/20250220173530705_IEcme9.png)",
          ...
          >
            ...
            >
              <h2
                ...
                dangerouslySetInnerHTML={{ __html: "DRIVER-CENTRIC COCKPIT" }}
              />
            </motion.div>
          </motion.div>
        </motion.div>
