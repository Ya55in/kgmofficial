...
const RextonPage = () => {
  ...
  const [isAdditionalSafetyCarouselOpen, setIsAdditionalSafetyCarouselOpen] = useState(false);
  const [isSeatingConfigCarouselOpen, setIsSeatingConfigCarouselOpen] = useState(false);
  const [isNVHCarouselOpen, setIsNVHCarouselOpen] = useState(false);
  ...
  const [showSpecialLineupFeatures, setShowSpecialLineupFeatures] = useState(false);
  ...
  const features = [
    ...
    },
    {
      ...
      description: language === 'fr' ? "Sécurité Garantie" : "Guaranteed Safety"
    }
  ];
  ...
  const safetyFeatures = [
    {
      ...
      subtitle: language === 'fr' ? "Châssis à quatre couches" : "Quadruple-layered frame",
      description: language === 'fr' ? "Contrairement à un véhicule de type monocoque, le moteur et la suspension sont montés sur un châssis en acier ; cela garantit la sécurité lors des impacts tout en optimisant le contrôle du bruit des sources externes." : "Unlike a monocoque body type vehicle, the engine and suspension are mounted on a steel frame; this ensures safety upon impacts while also optimizing noise control from external sources.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/structural-rigidity.jpg",
      video: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/structural-rigidity.mp4",
      bgColor: "bg-gray-800",
    ...
    {
      id: 1,
      title: language === 'fr' ? "Conçu pour la sécurité" : "Designed for safety",
      subtitle: language === 'fr' ? "81.7% d'acier haute résistance" : "81.7% High-strength steel",
      description: language === 'fr' ? "Avec une conception structurelle renforcée, Rexton offre une rigidité de conduite améliorée, une résistance globale du corps renforcée et une sécurité accrue, en particulier autour de la zone de l'habitacle." : "With a reinforced structural design, Rexton offers enhanced driving rigidity, improved overall body strength, and heightened safety, especially around the cabin area.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/high-strength-steel.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-white",
      subtitleColor: "text-white",
    ...
    {
      id: 2,
      title: language === 'fr' ? "Prioriser la sécurité de tous" : "Keeping everyone safe",
      subtitle: language === 'fr' ? "9 airbags" : "9 airbags",
      description: language === 'fr' ? "Un total de 9 airbags : siège conducteur et passager avant (2 EA), protection genou conducteur (1 EA), côté conducteur et passager avant et côté siège arrière (4 EA), et rideau (2 EA)." : "A total of 9 airbags: driver and front passenger's seat (2 EA), driver knee protection (1 EA), driver and front passenger's side and rear seat side (4 EA), and curtain (2 EA).",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/9-airbags.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-white",
      subtitleColor: "text-white",
    ...
    },
    {
      ...
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/acc-ssa.jpg",
      video: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/acc-ssa.mp4",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
      hasOpenButton: false
    },
    {
      ...
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/aeb.jpg",
      video: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/aeb.mp4",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
      hasOpenButton: true
    ...
    {
      id: 5,
      title: language === 'fr' ? "Direction plus sûre lors du remorquage" : "Safer steering when towing",
      subtitle: language === 'fr' ? "Assistance à la Stabilité de Remorque (TSA)" : "Trailer Stability Assist (TSA)",
      description: language === 'fr' ? "Lors du remorquage d'une remorque ou d'une caravane, le TSA stabilise le contrôle de direction en réponse au balancement latéral causé par des conditions routières difficiles." : "When towing a trailer or caravan, TSA stabilizes steering control in response to side-to-side swaying caused by harsh road conditions.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/tsa.jpg",
      video: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/tsa.mp4",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
      hasOpenButton: false
    },
    {
      ...
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/esc.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-white",
      subtitleColor: "text-white",
    ...
    },
    {
      ...
      subtitle: language === 'fr' ? "Systèmes de Sécurité Améliorés" : "Enhanced Safety Systems",
      description: language === 'fr' ? "Fonctionnalités de sécurité complètes incluant des systèmes d'assistance au conducteur avancés et des technologies de protection pour une tranquillité d'esprit maximale." : "Comprehensive safety features including advanced driver assistance systems and protective technologies for maximum peace of mind.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/safety/additional-features.jpg",
      video: "",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
  ...
  const convenienceFeatures = [
    {
      ...
      description: language === 'fr' ? "Quatre caméras extérieures surveillent en permanence le stationnement et la conduite, offrant une vision claire et précise de l'arrière du véhicule et de son environnement proche." : "Four cameras on the exterior monitor parking and driving, helpfully providing a clear view of the rear and ground areas.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/blind-spot-monitoring.jpg",
      video: "",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
    ...
    },
    {
      ...
      subtitle: language === 'fr' ? "Siège conducteur réglable électriquement à 8 directions" : "8-way power-adjustable driver seat",
      description: language === 'fr' ? "Siège conducteur réglable électriquement à 8 directions et support lombaire à 2 directions, siège réglable électriquement à 6 directions pour offrir une expérience de conduite confortable." : "8-way power-adjustable driver seat and 2-way lumber support, 6-way power-adjustable seat provides a comfortable driving experience.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/comfort-driving.jpg",
      video: "",
      bgColor: "bg-gray-200",
    ...
    {
      id: 2,
      title: language === 'fr' ? "Espace bagages de classe supérieure" : "Best-in-class luggage space",
      subtitle: language === 'fr' ? "Configurations d'assise" : "Seating configurations",
      description: language === 'fr' ? "Quatre sacs de golf peuvent être rangés facilement à l'horizontale, sans nécessiter le rabattement des sièges de la deuxième rangée." : "Four golf caddy bags can be conveniently loaded horizontally without needing to fold the second-row seats.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/luggage-space.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-white",
      subtitleColor: "text-white",
      ...
      expandedImages: [
        {
          title: language === 'fr' ? "2ème rangée 100% pliée" : "2nd row 100% folded",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/luggage-space-expanded/2nd-row-100-folded.jpg"
        },
        {
          title: language === 'fr' ? "2ème rangée 40% pliée" : "2nd row 40% folded",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/luggage-space-expanded/2nd-row-40-folded.jpg"
        },
        {
          title: language === 'fr' ? "2ème rangée 60% pliée" : "2nd row 60% folded",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/luggage-space-expanded/2nd-row-60-folded.jpg"
        }
      ]
    },
    {
      ...
      description: "",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features.jpg",
      video: "",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
      ...
      expandedImages: [
        {
          title: language === 'fr' ? "Hayon électrique intelligent" : "Smart power tailgate",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/smart-power-tailgate.jpg"
        },
        {
          title: language === 'fr' ? "Dispositif d'accès passager" : "Passenger's seat walk-in device",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/passenger-seat-walk-in.jpg"
        },
        {
          title: language === 'fr' ? "Aération arrière sur console centrale" : "Rear air vent on centre console",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/rear-air-vent.jpg"
        },
        {
          title: language === 'fr' ? "Connectivité voiture - Apple CarPlay & Android Auto" : "Car connectivity - Apple CarPlay & Android Auto",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/car-connectivity.jpg"
        },
        {
          title: language === 'fr' ? "Vitres électriques avant et toutes sécurisées" : "Front and all safety power windows",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/power-windows.jpg"
        },
        {
          title: language === 'fr' ? "Réglages de mémoire d'assise pour les conducteurs" : "Seating memory settings for the drivers",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/seating-memory.jpg"
        },
        {
          title: language === 'fr' ? "Rétroviseurs extérieurs inclinaison automatique en marche arrière" : "Automatic tilt-down external mirrors when reversing",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/tilt-mirrors.jpg"
        },
        {
          title: language === 'fr' ? "Chargeur mobile sans fil (15W)" : "Wireless mobile charger (15W)",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/wireless-charger.jpg"
        },
        {
          title: language === 'fr' ? "Emplacements USB type C sur la console avant et arrière" : "C-type USB slots on the front & back console",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/usb-slots.jpg"
        },
        {
          title: language === 'fr' ? "Poignées de porte tactiles 2 canaux avec éclairage externe (1ère rangée)" : "2-channel touch-sensitive door handles with external lights (1st row)",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/touch-handles.jpg"
        },
        {
          title: language === 'fr' ? "Fermeture automatique" : "Auto closing",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/auto-closing.jpg"
        },
        {
          title: language === 'fr' ? "Sièges de 2ème rangée avec accoudoir central rabattable et porte-gobelet" : "2nd row seats with folding centre armrest & cupholder",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/folding-armrest.jpg"
        },
        {
          title: language === 'fr' ? "Essuie-glaces avant à détection de pluie" : "Rain-sensing front wipers",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/rain-sensing-wipers.jpg"
        },
        {
          title: language === 'fr' ? "Toit ouvrant électrique sécurisé" : "Safety powered sunroof",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/safety-sunroof.jpg"
        },
        {
          title: language === 'fr' ? "Sièges avant et arrière chauffants" : "Heated front and rear seats",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/heated-seats.jpg"
        },
        {
          title: language === 'fr' ? "Sièges avant ventilés" : "Ventilated front seats",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/ventilated-seats.jpg"
        },
        {
          title: language === 'fr' ? "Store manuel pour 2ème rangée" : "Manual roller blind for 2nd-row",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/roller-blind.jpg"
        },
        {
          title: language === 'fr' ? "Couverture de volant en cuir chauffante" : "Heated leather steering wheel cover",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/heated-steering.jpg"
        },
        {
          title: language === 'fr' ? "Protège-bas de porte avant éclairé (1ère rangée, option)" : "Illuminated front-door scuff (1st-row, option)",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/illuminated-scuff.jpg"
        },
        {
          title: language === 'fr' ? "Poignée d'assistance montant B" : "B-pillar assist grip",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/assist-grip.jpg"
        },
        {
          title: language === 'fr' ? "Console plafond et éclairage cabine LED" : "Overhead console & LED cabin light",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/overhead-console.jpg"
        },
        {
          title: language === 'fr' ? "Rétroviseurs extérieurs avec lampe de marquage" : "Exterior rear view mirrors with puddle lamp",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/CONVENIENCE/more-features-expanded/puddle-lamp.jpg"
        }
      ]
    }
  ];
  ...
  const performanceFeatures = [
    {
      ...
      description: language === 'fr' ? "En conditions normales, il fonctionne en traction à deux roues, mais sur des routes enneigées ou pluvieuses, il peut passer activement en 4H, et pour la conduite tout-terrain, il peut sélectionner 4L." : "Under normal conditions, it operates in two-wheel drive, but on snowy or rainy roads, it can actively switch to 4H, and for off-road driving, it can select 4L.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/selectable-wheel-drive.jpg",
      video: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/selectable-wheel-drive.mp4",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
      hasOpenButton: false
    },
    {
      ...
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/locking-differential.jpg",
      video: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/locking-differential.mp4",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
      hasOpenButton: false
    },
    {
      ...
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/diesel-engine.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
    ...
    {
      id: 3,
      title: language === 'fr' ? "Commutateur 'Shift-By-Wire'" : "'Shift-By-Wire' toggle switch",
      subtitle: language === 'fr' ? "Transmission automatique 8 vitesses" : "8-speed automatic transmission",
      description: language === 'fr' ? "Transmission automatique électronique 8 vitesses, équipée d'un commutateur de déverrouillage pour prévenir les dysfonctionnements, offre des performances de changement de vitesse fluides et stables." : "8-speed electronic automatic transmission, equipped with an unlock switch to prevent malfunction, offers smooth and stable shifting performance.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/automatic-transmission.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
    ...
    {
      id: 4,
      title: language === 'fr' ? "Suspension avant à double triangulation" : "Front double-wishbone suspension",
      subtitle: language === 'fr' ? "Suspension arrière multi-bras" : "Multi-link rear suspension",
      description: language === 'fr' ? "Il fournit une traction maximale même sur des surfaces routières irrégulières, avec les impacts routiers dispersés à travers plusieurs liaisons, assurant une expérience de conduite stable." : "It provides maximum traction even on irregular road surfaces, with road impacts dispersed through multiple links, ensuring a stable driving experience.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/multi-link-suspension.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
    ...
    },
    {
      ...
      description: language === 'fr' ? "En adoptant la traction arrière (RWD), généralement trouvée dans les berlines premium, il offre une tenue de route stable en virage et une conduite confortable." : "By adopting rear-wheel drive (RWD), typically found in premium sedans, it offers stable cornering and a comfortable ride.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/rwd-system.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
    ...
    {
      id: 6,
      title: language === 'fr' ? "Performance de freinage améliorée" : "Enhanced braking performance",
      subtitle: language === 'fr' ? "Freins à disques ventilés avant et arrière" : "Ventilated disc brakes for front and rear",
      description: language === 'fr' ? "Il facilite le refroidissement facile de la chaleur générée par le frottement des disques, contribuant à des performances de freinage plus sûres et plus efficaces (roues avant et arrière)" : "It facilitates easy cooling of heat generated by disc friction, contributing to safer and more effective braking performance (front and rear wheels)",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/ventilated-brakes.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
    ...
    {
      id: 7,
      title: language === 'fr' ? "Support de conduite économique" : "Supporting economic driving",
      subtitle: language === 'fr' ? "Système ISG (Idle Stop & Go)" : "ISG system (Idle Stop & Go)",
      ...
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/isg-system.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
    ...
    {
      id: 8,
      title: language === 'fr' ? "Support de conduite agile" : "Supporting agile driving",
      subtitle: language === 'fr' ? "Palettes de changement" : "Paddle shifters",
      description: "Offering manual mode shifting with up/down shift controls on the steering wheel, allowing for quick response to sudden driving situations.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/paddle-shifters.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
    ...
    {
      id: 9,
      title: language === 'fr' ? "Fonction Auto-hold incluse" : "Auto-hold function included",
      subtitle: language === 'fr' ? "Frein de stationnement électronique avec fonction auto-hold" : "Electronic parking brake with auto-hold function",
      description: "It is toggle-switch type including auto-hold function.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/electronic-parking-brake.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
    ...
    },
    {
      ...
      description: "Meticulous attention to detail, even in hidden areas of the vehicle, ensures minimized interior noise through enhanced sound insulation.",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/nvh-control.jpg",
      video: "",
      bgColor: "bg-gray-800",
      textColor: "text-white",
      subtitleColor: "text-white",
      ...
      expandedImages: [
        {
          ...
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/nvh-control-expanded/engine-room-sealing.jpg"
        },
        {
          title: "Door quadruple structure sealing",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/nvh-control-expanded/door-quadruple-sealing.jpg"
        },
        {
          title: "polyethylene wheel house",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/nvh-control-expanded/polyethylene-wheel-house.jpg"
        },
        {
          title: "Noise control glass",
          image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/nvh-control-expanded/noise-control-glass.jpg"
        }
      ]
    },
    {
      ...
      description: "With an integrated steering and suspension system, optimal driving performance is maintained according to the selected mode (NORMAL/SPORTS/WINTER).",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/PERFORMANCE/drive-mode-system.jpg",
      video: "",
      bgColor: "bg-gray-200",
      textColor: "text-black",
      subtitleColor: "text-black",
  ...
  const specialLineupFeatures = [
    {
      ...
      description: "Equipped with a vertical partition panel, allowing for safe and efficient storage",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/SPECIALLINEUP/20250206090948971_vj6I1r.jpg"
    },
    {
      id: 1,
      title: "In-cable control and protection device (IC-CPD)",
      description: "Simple, easy charging",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/SPECIALLINEUP/20250206091009725_VKdNbH.jpg"
    }
  ];
  ...
  const specificationData = {
    dimensions: [
      { label: language === 'fr' ? "ROUES MOTRICES" : "DRIVEN WHEELS", value: "2WD" },
    ...
    powertrain: [
      ...
      { label: "Standard charging time (0 to 100%)", value: "Three phase : 30h (IC-CPD, 2kW), 9h (11kW)" },
      { label: "Fast charge time (10% to 80%)", value: "300kW: 37min, 100kW: 42min" },
    ...
    fuelEfficiency: [
      ...
      { label: "Electric energy consumption (Wh/km)", value: "135.5: City, 186.5: Combined" },
  ...
  const exteriorAccessories = [
    {
      ...
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/ACCESSORY/exterior/20250124183741695_NQUeeZ.jpg",
      description: language === 'fr' ? "Marchepieds latéraux pratiques avec surface antidérapante texturée" : "Convenient side steps with textured non-slip surface"
    }
  ];
  ...
  const interiorAccessories = [
    {
      ...
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/ACCESSORY/interior/20250124183936107_5MINPf.jpg",
      description: language === 'fr' ? "Système de purification d'air avancé pour un air intérieur propre" : "Advanced air purification system for clean interior air"
    },
    {
      id: 1,
      name: language === 'fr' ? "LAMPE DE PROJECTION DE PORTE" : "DOOR SPOT LAMP",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/ACCESSORY/interior/20250124183950181_9EdE5O.jpg",
      description: language === 'fr' ? "Seuil de porte éclairé avec projection du logo de la marque" : "Illuminated door sill with brand logo projection"
    },
    {
      id: 2,
      name: language === 'fr' ? "PÉDALE SPORT ALLIAGE" : "ALLOY SPORTS PEDAL",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/ACCESSORY/interior/20250124184004822_78G9wN.jpg",
      description: language === 'fr' ? "Couvre-pédales en alliage sportif avec poignée texturée" : "Sporty alloy pedal covers with textured grip"
    },
    {
      id: 3,
      name: language === 'fr' ? "CLIMATISATION SOUFFLAGE ARRIÈRE" : "AIR CONDITIONER AFTER BLOW",
      image: "https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/ACCESSORY/interior/20250124184019588_utnKhT.jpg",
      description: language === 'fr' ? "Système de climatisation avancé avec fonction de soufflage arrière" : "Advanced climate control system with after-blow feature"
    }
  ];
  ...
  const interiorHotspots = [
    {
      id: 'dashboard',
      position: { x: '31%', y: '28%' },
      title: language === 'fr' ? "Cluster Numérique 12,3\"" : "12.3\" Full-Digital Cluster",
      ...
      content: {
        ...
        image: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/Btnsinterior/btn1/20250204132428905_BRlPHX.jpg',
        texts: [
          language === 'fr' ? "Le cluster numérique de 12,3\" inclut trois modes d'affichage, une fonction de miroir AVN et des modes d'animation d'accueil et d'au revoir." : "12.3\" full-digital cluster includes three screen mode patterns, an AVN mirroring function and Welcome & Goodbye animation modes."
        ]
      }
    },
    {
      ...
      description: language === 'fr' ? "Navigation flottante intuitive" : "Intuitive floating navigation",
      content: {
        title: language === 'fr' ? "Navigation 12,3\"" : "12.3\" Navigation",
        subtitle: language === 'fr' ? "Navigation flottante intuitive" : "Intuitive floating navigation",
        image: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/Btnsinterior/btn2/20250204132450236_HemV8P.jpg',
        texts: [
          language === 'fr' ? "La navigation de type flottant offre une utilisabilité intuitive et fournit des mises à jour automatiques en temps réel lorsqu'elle est connectée à Internet." : "The floating-type navigation offers intuitive usability and provides real-time automatic updates when connected to the internet."
        ]
      }
    },
    {
      ...
      description: language === 'fr' ? "Réglage électrique précis" : "Precise electric adjustment",
      content: {
        title: language === 'fr' ? "Sièges Électriques" : "Electric Seats",
        subtitle: language === 'fr' ? "Réglage électrique précis" : "Precise electric adjustment",
        image: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/Btnsinterior/btn5/20250124173828184_MsDq1c.jpg',
        texts: [
          language === 'fr' ? "Les sièges électriques offrent un réglage précis et confortable pour une position de conduite optimale, avec des commandes intuitives et une mémoire des positions." : "The electric seats provide precise and comfortable adjustment for optimal driving position, with intuitive controls and position memory."
        ]
      }
    },
    {
      id: 'gear-selector',
      position: { x: '44%', y: '44%' },
      title: language === 'fr' ? "Système de Climatisation Double Zone" : "Front dual-temperature zone auto air conditioning system",
      description: language === 'fr' ? "Contrôleur d'affichage LCD intuitif" : "Intuitive LCD display controller",
      content: {
        title: language === 'fr' ? "Système de Climatisation Double Zone" : "Front dual-temperature zone auto air conditioning system",
        subtitle: language === 'fr' ? "Contrôleur d'affichage LCD intuitif" : "Intuitive LCD display controller",
        image: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/Btnsinterior/btn3/20250210202342178_L0EoWT.jpg',
        texts: [
          language === 'fr' ? "Le système de climatisation automatique double zone avant avec contrôleur d'affichage LCD intuitif et fonctions de chauffage rapide (PTC) et de dégivrage automatique." : "Front dual-temperature zone auto air conditioning system with intuitive LCD display controller and rapid heater (PTC) and auto defogging functions."
        ]
      }
    },
    {
      id: 'air-conditioning',
      position: { x: '60%', y: '41%' },
      title: language === 'fr' ? "32 Éclairages d'Ambiance" : "32 ambient lights",
      description: language === 'fr' ? "Créer diverses atmosphères" : "Create various atmospheres",
      content: {
        title: language === 'fr' ? "32 Éclairages d'Ambiance" : "32 ambient lights",
        subtitle: language === 'fr' ? "Créer diverses atmosphères" : "Create various atmospheres",
        image: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/Btnsinterior/btn4/20250827173601141_meEyFa.jpg',
        texts: [
          language === 'fr' ? "Créez diverses atmosphères à l'intérieur du véhicule en combinant l'éclairage indirect sur l'avant de l'IP, et les garnitures de portes, et les lampes de pied, avec jusqu'à 32 options de couleurs." : "Create various atmospheres inside the vehicle by combining indirect lighting on the IP front, and door trim, and foot lamps, with up to 32 color options."
        ]
      }
    }
  ];
  ...
  const nextInteriorHotspotImage = () => {
    ...
    if (content) {
      ...
      const imagesCount = 'images' in content && Array.isArray(content.images) ? content.images.length : 0;
  ...
  const prevInteriorHotspotImage = () => {
    ...
    if (content) {
      ...
      const imageCount = 'image' in content && content.image ? 1 : 0;
      const totalItems = videoCount + imagesCount + imageCount;
      setCurrentInteriorHotspotImage((prev) => (prev === 0 ? totalItems - 1 : prev - 1));
    }
  };
  ...
  const getHotspotContent = (hotspotId: string) => {
    ...
    if (hotspotId === 'headlight') {
      return {
        title: language === 'fr' ? 'Phares LED 4-balles avant avec LED DRL' : 'Full LED 4-ball front head lights with LED DRL',
        subtitle: language === 'fr' ? 'Système d\'éclairage LED avancé' : 'Advanced LED lighting system',
        video: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/Btns/btn1/20250124171010570_rCapxn.mp4',
        texts: [
    ...
    if (hotspotId === 'wheel') {
      return {
        title: language === 'fr' ? 'Calandre stylée en forme de maille de luxe' : 'Deluxed mesh-shaped radiator grille',
        ...
        texts: [
          language === 'fr' ? 'Calandre stylée en forme de maille de luxe avec finition Satin Silver' : 'Deluxed mesh-shaped radiator grille with Satin Silver finish'
        ]
      };
    }
    ...
    if (hotspotId === 'grille') {
      return {
        title: language === 'fr' ? 'Lampe de virage avec phare antibrouillard LED intégré' : 'Cornering lamp with built-in LED fog lamp',
        subtitle: language === 'fr' ? 'Noir brillant haute qualité' : 'Black high glossy',
        video: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/Btns/btn3/20250210210015747_XBELB8.mp4',
        texts: [
          language === 'fr' ? 'Lampe de virage avec phare antibrouillard LED intégré, finition noire brillante haute qualité' : 'Cornering lamp with built-in LED fog lamp, black high glossy finish'
        ]
      };
    }
    ...
    if (hotspotId === 'foglight') {
      return {
        ...
        texts: [
          language === 'fr' ? '18" jantes alliage finition diamant (P255/60R18)' : '18" diamond-cut finished alloy wheels (P255/60R18)',
          language === 'fr' ? '20" jantes alliage finition diamant (P255/50R20)' : '20" diamond-cut finished alloy wheels (P255/50R20)',
          language === 'fr' ? '20" jantes alliage finition diamant (P255/50R20)' : '20" diamond-cut finished alloy wheels (P255/50R20)'
        ]
      };
    }
  ...
  const carColors = [
    {
      id: 0,
      name: 'Space Black',
      oneTone: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section3/Space%20Black/1tone/20250124172106000_AtKCOM.jpg',
      twoTone: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section3/Space%20Black/2tone/20250210195308373_pelBG1.jpg',
      colorSwatch: '#1A1A1A',
      hasTwoTones: true, // This color has two tones
      vrImages: {
        oneTone: Array.from({ length: 36 }, (_, i) => `https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/vr360/space-black-1tone/${String(i + 1).padStart(2, '0')}.png`),
        twoTone: Array.from({ length: 36 }, (_, i) => `https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/vr360/space-black-2tone/${String(i + 1).padStart(2, '0')}.png`)
      }
    },
    {
      id: 1,
      name: 'Elemental Gray',
      oneTone: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section3/Elemental%20Gray/20250124172355810_aFC7rE.jpg',
      twoTone: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section3/Elemental%20Gray/20250124172355810_aFC7rE.jpg', // Same image for both tones
      colorSwatch: '#6B6B6B',
      hasTwoTones: false, // This color only has one tone
      vrImages: {
        oneTone: Array.from({ length: 36 }, (_, i) => `https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/vr360/elemental-gray-1tone/${String(i + 1).padStart(2, '0')}.png`),
        twoTone: Array.from({ length: 36 }, (_, i) => `https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/vr360/elemental-gray-1tone/${String(i + 1).padStart(2, '0')}.png`) // Same VR images since only 1-tone available
      }
    },
    {
      id: 2,
      name: 'Grand White',
      oneTone: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section3/Grand%20White/20250124172631603_OKPwlc.jpg',
      twoTone: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section3/Grand%20White/20250124172631603_OKPwlc.jpg', // Same image for both tones
      colorSwatch: '#FFFFFF',
      hasTwoTones: false, // This color only has one tone
      vrImages: {
        oneTone: Array.from({ length: 36 }, (_, i) => `https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/vr360/grand-white-1tone/${String(i + 1).padStart(2, '0')}.png`),
        twoTone: Array.from({ length: 36 }, (_, i) => `https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/vr360/grand-white-1tone/${String(i + 1).padStart(2, '0')}.png`) // Same VR images since only 1-tone available
      }
    },
    {
      id: 3,
      name: 'Marble Gray',
      oneTone: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section3/Marble%20Gray/20250124172822194_AxHu4l.jpg',
      twoTone: 'https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section3/Marble%20Gray/20250124172822194_AxHu4l.jpg', // Same image for both tones
      colorSwatch: '#8B8B8B',
      hasTwoTones: false, // This color only has one tone
      vrImages: {
        oneTone: Array.from({ length: 36 }, (_, i) => `https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/vr360/marble-gray-1tone/${String(i + 1).padStart(2, '0')}.png`),
        twoTone: Array.from({ length: 36 }, (_, i) => `https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/vr360/marble-gray-1tone/${String(i + 1).padStart(2, '0')}.png`) // Same VR images since only 1-tone available
      }
    }
  ];
  ...
  const adasCarouselData = React.useMemo(() => [
    {
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175103847_58Aa9K.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175103756_z7f3OE.jpg'
    },
    {
      id: 1,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175123999_8Ja2j0.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175123860_hkVNgN.jpg'
    },
    {
      id: 2,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175144976_bORaKI.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175144877_PXB6Kh.jpg'
    },
    {
      id: 3,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175211319_0sZruL.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175211226_f8RzI9.jpg'
    },
    {
      id: 4,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175231803_yimIum.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175231692_tCGqSX.jpg'
    },
    {
      id: 5,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175251712_4OBqEw.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175251601_dAXw4f.jpg'
    },
    {
      id: 6,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175311952_xrpGo2.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175311834_ihQbFg.jpg'
    },
    {
      id: 7,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175332113_457JXX.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175332004_bQ4gkL.jpg'
    },
    {
      id: 8,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175351758_CSpWlK.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175351644_kawqEY.jpg'
    }
  ], [language]);
  ...
  const moreFeaturesCarouselData = React.useMemo(() => [
    {
      ...
      title: language === 'fr' ? 'Hayon électrique intelligent' : 'Smart power tailgate',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180907489_oJc3ny.jpg'
    },
    {
      id: 1,
      title: language === 'fr' ? 'Dispositif d\'accès passager' : 'Passenger\'s seat walk-in device',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180921653_TBELr8.jpg'
    },
    {
      id: 2,
      title: language === 'fr' ? 'Aération arrière sur console centrale' : 'Rear air vent on centre console',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180935581_2iSHeX.jpg'
    },
    {
      id: 3,
      title: language === 'fr' ? 'Connectivité voiture - Apple CarPlay & Android Auto' : 'Car connectivity - Apple CarPlay & Android Auto',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180949694_GMJHvY.jpg'
    },
    {
      id: 4,
      title: language === 'fr' ? 'Vitres électriques avant et toutes sécurisées' : 'Front and all safety power windows',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181003738_SynVt4.jpg'
    },
    {
      id: 5,
      title: language === 'fr' ? 'Réglages de mémoire d\'assise pour les conducteurs' : 'Seating memory settings for the drivers',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181018053_i7DXIx.jpg'
    },
    {
      id: 6,
      title: language === 'fr' ? 'Rétroviseurs extérieurs inclinaison automatique en marche arrière' : 'Automatic tilt-down external mirrors when reversing',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181032570_mKpGio.jpg'
    },
    {
      id: 7,
      title: language === 'fr' ? 'Chargeur mobile sans fil (15W)' : 'Wireless mobile charger (15W)',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250224105415672_70DZTu.jpg'
    },
    {
      id: 8,
      title: language === 'fr' ? 'Emplacements USB type C sur la console avant et arrière' : 'C-type USB slots on the front & back console',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181103343_yD4Q73.jpg'
    },
    {
      id: 9,
      title: language === 'fr' ? 'Poignées de porte tactiles 2 canaux avec éclairage externe (1ère rangée)' : '2-channel touch-sensitive door handles with external lights (1st row)',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181119399_gNbLQJ.jpg'
    },
    {
      id: 10,
      title: language === 'fr' ? 'Fermeture automatique' : 'Auto closing',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181134035_GPpPPl.jpg'
    },
    {
      id: 11,
      title: language === 'fr' ? 'Sièges de 2ème rangée avec accoudoir central rabattable et porte-gobelet' : '2nd row seats with folding centre armrest & cupholder',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181148474_SwriGx.jpg'
    },
    {
      id: 12,
      title: language === 'fr' ? 'Essuie-glaces avant à détection de pluie' : 'Rain-sensing front wipers',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181202952_5NsJKo.jpg'
    },
    {
      id: 13,
      title: language === 'fr' ? 'Toit ouvrant électrique sécurisé' : 'Safety powered sunroof',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181217411_iFoNlv.jpg'
    },
    {
      id: 14,
      title: language === 'fr' ? 'Sièges avant et arrière chauffants' : 'Heated front and rear seats',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181232312_5wANS1.jpg'
    },
    {
      id: 15,
      title: language === 'fr' ? 'Sièges avant ventilés' : 'Ventilated front seats',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181246969_JeWfar.jpg'
    },
    {
      id: 16,
      title: language === 'fr' ? 'Store manuel pour 2ème rangée' : 'Manual roller blind for 2nd-row',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181301221_KgOFiz.jpg'
    },
    {
      id: 17,
      title: language === 'fr' ? 'Couverture de volant en cuir chauffante' : 'Heated leather steering wheel cover',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181315373_PflZOj.jpg'
    },
    {
      id: 18,
      title: language === 'fr' ? 'Protège-bas de porte avant éclairé (1ère rangée, option)' : 'Illuminated front-door scuff (1st-row, option)',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181329715_Cujrkc.jpg'
    },
    {
      id: 19,
      title: language === 'fr' ? 'Poignée d\'assistance montant B' : 'B-pillar assist grip',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181344210_L0Fnhh.jpg'
    },
    {
      id: 20,
      title: language === 'fr' ? 'Console plafond et éclairage cabine LED' : 'Overhead console & LED cabin light',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181358588_P2lbjW.jpg'
    },
    {
      id: 21,
      title: language === 'fr' ? 'Rétroviseurs extérieurs avec lampe de marquage' : 'Exterior rear view mirrors with puddle lamp',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124181413770_mKpuXY.jpg'
    }
  ], [language]);

  // NVH Control Carousel Data
  const nvhCarouselData = React.useMemo(() => [
    {
      id: 0,
      title: 'Engine room around sealing',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124183011293_SYomd6.jpg'
    },
    {
      id: 1,
      title: 'Door quadruple structure sealing',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250214180736750_hdLZYV.jpg'
    },
    {
      id: 2,
      title: 'polyethylene wheel house',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124183040291_XzxVW2.jpg'
    },
    {
      id: 3,
      title: 'Noise control glass',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124183054875_2kXZk3.jpg'
    }
  ], []);
  ...
  const escCarouselData = React.useMemo(() => [
    {
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175726577_E6f66j.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175726471_ISnF8c.jpg'
    },
    {
      id: 1,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175746339_vBJzHj.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175746237_t0wGE1.jpg'
    },
    {
      id: 2,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175805836_pgWG4N.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175805697_R2FBuX.jpg'
    },
    {
      id: 3,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175825765_T7wjZt.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175825646_QwCFlK.jpg'
    },
    {
      id: 4,
      ...
      video: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175846296_RExl4K.mp4',
      poster: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124175846174_7eLYWQ.jpg'
    }
  ], [language]);
  ...
  const additionalSafetyCarouselData = React.useMemo(() => [
    {
      ...
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180028615_wvhLiz.jpg'
    },
    {
      id: 1,
      title: language === 'fr' ? 'Fixation de Siège Enfant (ISO-FIX)' : 'Child seat anchorage (ISO-FIX)',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180051963_rpJ7FH.jpg'
    }
  ], [language]);
  ...
  const seatingConfigCarouselData = React.useMemo(() => [
    {
      ...
      title: language === 'fr' ? '2ème rangée 100% pliée' : '2nd row 100% folded',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180700107_TlJfxk.jpg'
    },
    {
      id: 1,
      title: language === 'fr' ? '2ème rangée 40% pliée' : '2nd row 40% folded',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180714491_2OqDFz.jpg'
    },
    {
      id: 2,
      title: language === 'fr' ? '2ème rangée 60% pliée' : '2nd row 60% folded',
      description: '',
      image: 'https://en.kg-mobility.com/attached/contents/display/video/2000003000100050004/20250124180730389_MxahIC.jpg'
    }
  ], [language]);
  ...
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      if (event.key === 'Escape') {
        ...
        if (isNVHCarouselOpen) {
          setIsNVHCarouselOpen(false);
        }
      }
    };

    if (isADASCarouselOpen || isMoreFeaturesCarouselOpen || isESCCarouselOpen || isAdditionalSafetyCarouselOpen || isSeatingConfigCarouselOpen || isNVHCarouselOpen) {
      document.addEventListener('keydown', handleKeyDown);
      return () => document.removeEventListener('keydown', handleKeyDown);
    }
  }, [isADASCarouselOpen, isMoreFeaturesCarouselOpen, isESCCarouselOpen, isAdditionalSafetyCarouselOpen, isSeatingConfigCarouselOpen, isNVHCarouselOpen]);
  ...
  const nextPerformanceCard = () => {
    ...
    setCurrentPerformanceCard((prev) => Math.min(prev + 1, performanceFeatures.length - 6));
  };
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/hero/rexton_hero_video.mp4" type="video/mp4" />
        ...
        <div className="relative z-10 h-full flex flex-col">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-info mb-4">
                ...
                <p className="text-lg text-white font-light">
                  <span>{language === 'fr' ? "Quand l'élégance rencontre la performance" : "When elegance meets performance"}</span>
                </p>
              </div>
          ...
          {/* Bottom Content - REXTON title, subtitle, and buttons - Desktop only */}
          <div className="hidden lg:flex justify-center lg:justify-start px-8 sm:px-12 lg:px-16 pb-16">
            ...
            >
              ...
              >
                {language === 'fr' ? "Quand l'élégance rencontre la performance" : "When elegance meets performance"}
              </motion.p>
       ...
       <section ref={section2Ref} className="relative  bg-black overflow-hidden">
         ...
         <div className="absolute inset-0 z-0 flex items-center justify-center">
           ...
           >
             ...
             >
               <source src="https://vbcgnalssebtzofpeslx.supabase.co/storage/v1/object/public/media/assets/Modelspage/REXTON/section1/rexton_section1_video.mp4" type="video/mp4" />
             </video>
      ...
      <section ref={section2Ref} className="relative h-screen bg-black overflow-hidden z-20">
        ...
        >
          ...
          >
            {language === 'fr' ? "COURBES ÉLÉGANTES ET MAJESTUEUSES" : "ELEGANT AND MAJESTIC CURVES"}
          </motion.h2>
        </motion.div>
       ...
       <section className="relative min-h-[41vh] lg:min-h-[800px] bg-gradient-to-b from-black via-gray-900 to-black overflow-hidden py-8 lg:py-16">
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center mt-20 lg:mt-16 -top-[122px] lg:top-0">
          <motion.div
            ...
            className="relative w-full max-w-[90%] lg:max-w-none h-[35vh] lg:h-[600px] flex items-center justify-center lg:mb-40"
          >
            <Image
      ...
      <section className="relative bg-black overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center mt-8">
          {(viewMode as 'color' | 'vr') === 'color' ? (
            ...
            <div className="absolute bottom-4 lg:bottom-0 left-1/2 transform -translate-x-1/2 z-20">
              <motion.div
                initial={{ opacity: 1, y: 0 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0 }}
                className="bg-white/20 backdrop-blur-sm rounded-lg lg:rounded-lg p-2 lg:p-2.5 max-w-[98%] lg:max-w-[10rem] mx-auto shadow-2xl"
              >
                {/* Current Color Name */}
                ...
                {/* Color Swatches */}
                <div className="flex justify-center gap-1 lg:gap-2 mb-1.5 lg:mb-2">
                  {carColors.map((color) => (
                    <motion.button
                      key={color.id}
                    ...
                    >
                      {selectedColor === color.id && (
                        <div className="w-full h-full rounded-full flex items-center justify-center">
                          <svg className="text-white w-2 h-2 lg:w-2 lg:h-2" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex justify-center gap-3 lg:gap-5">
                  <label className="flex items-center gap-1 lg:gap-1 cursor-pointer">
                    <input
                      type="radio"
                      name="tone"
                      value="1 TONE"
                    ...
                    />
                    <span className="text-white font-semibold text-[9px] lg:text-[10px]">{language === 'fr' ? "1 TON" : "1 TONE"}</span>
                  </label>
                  <label className="flex items-center gap-1 lg:gap-1 cursor-pointer">
                    <input
                      type="radio"
                      ...
                      className="w-2.5 h-2.5 lg:w-3 lg:h-3 text-blue-600"
                    />
                    <span className="text-white font-semibold text-[9px] lg:text-[10px]">{language === 'fr' ? "2 TONS" : "2 TONE"}</span>
                  </label>
                </div>
                )}
              </motion.div>
        ...
        <section className="relative bg-black overflow-hidden">
          ...
          <div className="relative w-full h-[35vh] md:h-screen flex items-center justify-center overflow-hidden px-0 pt-24 md:pt-32">
            <div className="absolute left-0 right-0 bottom-0 top-auto md:inset-x-0 md:top-0 md:h-full h-full w-full" style={{ bottom: isMobile ? '5px' : undefined }}>
              <Image
            ...
            <div className="hidden md:block absolute bottom-8 left-8 z-30">
              <h3 className="text-white text-4xl md:text-5xl font-bold mb-2">{language === 'fr' ? "BEIGE CLASSIQUE" : "CLASSIC BEIGE"}</h3>
              <p className="text-white text-sm opacity-80">{language === 'fr' ? "* Les photos et descriptions sont fournies à titre indicatif uniquement et peuvent différer du produit réel." : "* The photos and descriptions are for reference only and may differ from the actual product."}</p>
            </div>
            
            {/* Interactive Interior Hotspots */}
            {interiorHotspots.map((hotspot) => {
              // Calculate adjusted position for mobile (image container is now 100% height, positioned at bottom with 5px margin)
              // Convert from top-based to bottom-based positioning
              const yPercent = parseFloat(hotspot.position.y);
              // Image is now 100% height at bottom, so: bottom position = 100% - yPercent
              // Exclude 'seats' hotspot (x: 65% which becomes 62% after -3 adjustment) from moving up
              const isSeatsHotspot = parseFloat(hotspot.position.x) === 65;
              // Calculate base bottom position
              const baseYFromBottom = 100 - yPercent + 4;
              ...
              return (
                <motion.button
                  ...
                  style={{
                    left: isMobile ? `calc(${adjustedX}% + 8px)` : hotspot.position.x,
                    bottom: isMobile 
                      ? (isSeatsHotspot 
                          ? `calc(${baseYFromBottom}% - 25px)` // Keep original for seats
                          : `calc(${baseYFromBottom}% - 25px - 15px)`) // Move up by 15px (10px + 5px) for others
                      : undefined,
          ...
          <div className="relative w-full h-screen flex items-center justify-center">
            ...
            <div className="absolute bottom-8 left-8 z-30">
              <h3 className="text-white text-4xl md:text-5xl font-bold mb-2">{language === 'fr' ? "NOIR" : "BLACK"}</h3>
              <p className="text-white text-sm opacity-80">{language === 'fr' ? "* Les photos et descriptions sont fournies à titre indicatif uniquement et peuvent différer du produit réel." : "* The photos and descriptions are for reference only and may differ from the actual product."}</p>
            </div>
          </div>
          ...
          <div className="relative w-full h-screen flex items-center justify-center">
            ...
            {/* Color Scheme Text Overlay */}
            <div className="absolute bottom-8 left-8 z-30">
              <h3 className="text-white text-4xl md:text-5xl font-bold mb-2">{language === 'fr' ? "BEIGE CLASSIQUE" : "CLASSICAL BEIGE"}</h3>
              <p className="text-white text-sm opacity-80">{language === 'fr' ? "* Les photos et descriptions sont fournies à titre indicatif uniquement et peuvent différer du produit réel." : "* The photos and descriptions are for reference only and may differ from the actual product."}</p>
            </div>
          </div>
          ...
          <div className="relative w-full h-screen flex items-center justify-center">
            ...
            {/* Color Scheme Text Overlay */}
            <div className="absolute bottom-8 left-8 z-30">
              <h3 className="text-white text-4xl md:text-5xl font-bold mb-2">{language === 'fr' ? "ROUGE BORDEAUX" : "MAROON RED"}</h3>
              <p className="text-white text-sm opacity-80">{language === 'fr' ? "* Les photos et descriptions sont fournies à titre indicatif uniquement et peuvent différer du produit réel." : "* The photos and descriptions are for reference only and may differ from the actual product."}</p>
            </div>
          </div>
        </section>
        ...
        <section className="relative py-20 bg-black overflow-hidden w-full">
          ...
          <div className="text-center mb-16">
            ...
            >
              {language === 'fr' ? "SÉCURITÉ ET SÉRÉNITÉ SUR TOUTES LES ROUTES" : "SAFE AND SOUND ON EVERY ROAD"}
            </h1>
            </div>
                            ...
                            <div className="text-box absolute inset-0 p-6 md:p-8 flex flex-col justify-between z-10">
                              ...
                              <div className="flex flex-col backdrop-blur-sm bg-black/10 rounded-lg p-3 md:p-4">
                                ...
                                {feature.hasOpenButton && (
                                  <ToggleButton
                                    isOpen={(feature.id === 6 && isESCCarouselOpen) || (feature.id === 7 && isAdditionalSafetyCarouselOpen)}
                                    onClick={() => {
                                      if (feature.id === 6) {
                                        setIsESCCarouselOpen(prev => !prev);
                                      } else if (feature.id === 7) {
                                        setIsAdditionalSafetyCarouselOpen(prev => !prev);
                                      }
                                    }}
                                  />
                                )}
                              ...
                              <div className="flex flex-col gap-4 backdrop-blur-sm bg-black/10 rounded-lg p-3 md:p-4">
                                <p className={`${
                                  (feature.description.includes('With a reinforced structural design') ||
                                   feature.description.includes('A total of 9 airbags'))
                                    ? 'text-white'
                                    : feature.textColor
                                ...
                                {feature.video && (
                                  ...
                                  >
                                    ...
                                    <span className="text-sm font-medium">{language === 'fr' ? "Regarder la Vidéo" : "Watch Video"}</span>
                                  </button>
                                )}
                              </div>
                            </div>
        ...
        <section className="relative py-20 bg-black overflow-hidden">
          ...
          <div className="text-center mb-16">
            ...
            >
              {language === 'fr' ? "DES DEPLACEMENTS PLUS INTELLIGENTS, PLUS FACILES ET PLUS CONFORTABLES" : "FOR SMARTER, EASIER AND COMFORTABLE MOVES"}
            </h1>
          </div>

          {/* Horizontal Card Slider Container */}
          <div className="relative max-w-7xl mx-auto px-0 md:px-4">
            {/* Cards Container */}
            <div className="relative overflow-hidden">
              <div 
                className="flex transition-transform duration-700 ease-out convenience-slider"
                style={{ 
                  transform: isMobile
              ...
              >
                {convenienceFeatures.map((feature, index) => (
                  <React.Fragment key={feature.id}>
                        ...
                        <div className="gallery-wrap rounded-lg overflow-hidden relative" style={{ height: isMobile ? '450px' : '514px' }}>
                          ...
                          {!(playingVideo === feature.video && videoPlaying) && (
                            ...
                            <div className="md:hidden backdrop-blur-sm bg-black/10 rounded-lg p-3 md:p-4">
                              ...
                              {feature.subtitle && (
                                <h2 className="text-white text-xl font-bold mb-3 drop-shadow-lg">{feature.subtitle}</h2>
                              )}
                              {feature.hasOpenButton && (
                                <ToggleButton
                                  isOpen={(feature.id === 2 && isSeatingConfigCarouselOpen) || (feature.id === 3 && isMoreFeaturesCarouselOpen)}
                                  onClick={() => {
                                    if (feature.id === 2) {
                                      setIsSeatingConfigCarouselOpen(prev => !prev);
                                    } else if (feature.id === 3) {
                                      setIsMoreFeaturesCarouselOpen(prev => !prev);
                                    }
                                  }}
                                />
                              )}
                            ...
                            {/* Desktop: Top Content */}
                            <div className="hidden md:flex flex-1 flex-col backdrop-blur-sm bg-black/10 rounded-lg p-3 md:p-4">
                              <h3 className="text-white text-sm font-light mb-2 drop-shadow-lg">{feature.title}</h3>
                              {feature.subtitle && (
                            ...
                            {/* Bottom Content */}
                            <div className="flex flex-col items-end gap-6 md:gap-0 backdrop-blur-sm bg-black/10 rounded-lg p-3 md:p-4">
                    ...
                    {/* Seating Configurations Carousel - appears after Best-in-class luggage space card */}
                    {feature.id === 2 && (
                      <SousSlider
        ...
        <section className="relative py-20 bg-black overflow-hidden">
          ...
          <div className="text-center mb-16">
            ...
            >
              {language === 'fr' ? "DÉPLACEMENT PUISSANT ET DYNAMIQUE" : "POWERFUL, DYNAMIC MOVE"}
            </h1>
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-0 md:px-4">
            ...
            <div className="relative overflow-hidden">
              <div 
                className="flex transition-transform duration-700 ease-out performance-slider"
                style={{ 
                  transform: isMobile
                    ? currentPerformanceCard === 0 
                      ? 'translateX(0%)'
                      : `translateX(calc(-${8 + currentPerformanceCard * 69}%))`
                    : `translateX(-${currentPerformanceCard * (100 / 6)}%)`
                }}
              ...
              >
                {performanceFeatures.map((feature, index) => (
                  <React.Fragment key={feature.id}>
                    <div className="performance-card flex-shrink-0 w-[65%] mr-[4%] md:mr-0 md:px-4" style={{ 
                      marginLeft: index === 0 && isMobile ? '8%' : '0',
                      width: isMobile ? '65%' : 'calc(16.666% + 100px)'
                    }}>
                      <div className="slide-item-wrap">
                        <div className="gallery-wrap rounded-lg overflow-hidden relative" style={{ height: isMobile ? '450px' : '514px' }}>
                          {/* Background Image or Video */}
                          ...
                          {feature.hasOpenButton && !(playingVideo === feature.video && videoPlaying) && (
                            <div className="absolute bottom-4 right-4 z-10">
                              <ToggleButton
                                isOpen={feature.id === 10 && isNVHCarouselOpen}
                                onClick={() => {
                                  if (feature.id === 10) {
                                    setIsNVHCarouselOpen(prev => !prev);
                                  }
                                }}
                              />
                            </div>
                    ...
                    {/* NVH Carousel - appears after NVH Control card */}
                    {feature.id === 10 && (
                      <SousSlider
                        items={nvhCarouselData}
                        isOpen={isNVHCarouselOpen}
                        onClose={() => setIsNVHCarouselOpen(false)}
                        cardWidth="320px"
                        language={language}
                        itemsPerView={3}
                      />
              ...
              <div className="hidden md:block">
                <CarouselNavigation
                  ...
                  onSlideChange={(index) => {
                    ...
                    setCurrentPerformanceCard(index);
                  }}
