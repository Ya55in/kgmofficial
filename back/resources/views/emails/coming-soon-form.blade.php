...
<head>
    ...
    <title>Nouvelle inscription Coming Soon - KGM Mobility</title>
</head>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #2d294e 0%, #1a1730 100%); padding: 40px 30px; text-align: center;">
                            <h1 style="color: #ffffff; font-size: 24px; font-weight: 600; margin: 0 0 8px 0; letter-spacing: -0.5px;">Nouvelle Inscription</h1>
                            <div style="color: #d4be83; font-size: 14px; font-weight: 500; text-transform: uppercase; letter-spacing: 1px;">Coming Soon</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding-bottom: 20px;">
                                        <div style="font-size: 12px; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px;">Ville</div>
                                        <div style="font-size: 16px; color: #111827; font-weight: 500;">{{ $submission->ville }}</div>
                                    </td>
                                </tr>
                                @endif
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #e5e7eb;">
                                <tr>
                                    <td>
                                        <p style="font-size: 12px; color: #9ca3af; margin: 4px 0;"><strong>Date d'inscription:</strong> {{ $submission->created_at->format('d/m/Y à H:i') }}</p>
